  ...
  return (
    <>
      ...
      >
        ...
        <div className="fixed m-2.5 left-0 bottom-0  w-full flex justify-center items-center flex-col">
          {!isUserLoggedIn && (
            <Link
              href="/login"
 ...
 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100"
            >
              <div className="relative flex items-center space-x-4 justify-center">
                <span className=" relative top-3 block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">
                  {" "}
                  Login
                </span>
              </div>
